...
//            )
            ...
            movies = movieService.listMovies()
                ...
                .body()
            movies?.forEach {
                info("${it.Title}   ${it.imdbRating}    ${it.Director}")
            }
            uiThread {
                with(recycler) {
    ...
    inner class MovieHolder(view: View) : RecyclerView.ViewHolder(view) {
        val titleText = view.tv_movie_title
        val imdbText = view.tv_movie_imdb
        val directorText = view.tv_movie_director
        val posterImg = view.img_movie_poster
